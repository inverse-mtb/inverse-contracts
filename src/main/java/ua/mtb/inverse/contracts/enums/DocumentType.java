...
public enum DocumentType {
  ACCOUNTING_ORDER_FILE_REV("100751", 10047, "Розпорядження на облікову операцію (Банк)"),
  ACCOUNTING_ORDER_FILE("100752", 10023, "Розпорядження на облікову операцію (Клієнт)"),
  ...
  ACCOUNTING_ORDER_CHANGE_FILE(
      "100713", 10043, "Розпорядження на внесення змін до анкети рахунку у цінних паперах"),
