...
public class PurchaseFilterPortfolioDto {
  ...
  @NotNull
  @Schema(description = "Ідентифікатор контрагента клієнта", example = "123456789")
  ...
  @Schema(description = "Початкова дата періоду придбання облігацій", example = "2026-01-01")
  private LocalDate startDate;

  @Schema(description = "Кінцева дата періоду придбання облігацій", example = "2026-12-31")
